...
class Xatkit_Chatbot_Connector {

    /**
     * The loader that's responsible for maintaining and registering all hooks that power
     * the plugin.
     *
     * @var      Xatkit_Chatbot_Connector_Loader $loader Maintains and registers all hooks for the plugin.
     */
    protected $loader;
    ...
    public function __construct() {
        if ( defined( 'XATKIT_CHATBOT_Connector_VERSION' ) ) {
            $this->version = XATKIT_CHATBOT_Connector_VERSION;
        } else {
            $this->version = '1.0.0';
        }
    ...
    private function load_dependencies() {
         ...
         * core plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-xatkit-chatbot-connector-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-xatkit-chatbot-connector-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-xatkit-chatbot-connector-admin.php';
         ...
         * side of the site.
         */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-xatkit-chatbot-connector-public.php';
        $this->loader = new Xatkit_Chatbot_Connector_Loader();
    }
    ...
    private function set_locale() {
        $plugin_i18n = new Xatkit_Chatbot_Connector_i18n();
    ...
    protected function define_admin_hooks() {
        $plugin_admin = new Xatkit_Chatbot_Connector_Admin( $this->get_plugin_name(), $this->get_version() );
        $this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
        $this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );
        $plugin_settings = null;
        $plugin_settings = new Xatkit_Chatbot_Connector_Admin_Settings( $this->get_plugin_name(), $this->get_version(), $plugin_admin );
        $this->loader->add_action( 'admin_init', $plugin_settings, 'init_settings' );    // Registering also the plugin settings
        $plugin_display = new Xatkit_Chatbot_Connector_Admin_Display( $this->get_plugin_name(), $this->get_version(), $plugin_admin, $plugin_settings );
    ...
    protected function define_public_hooks() {
        $plugin_public = new Xatkit_Chatbot_Connector_Public( $this->get_plugin_name(), $this->get_version() );
     ...
     *
     * @return    Xatkit_Chatbot_Connector_Loader    Orchestrates the hooks of the plugin.
     */
    ...
    protected function define_additional_admin_hooks( $plugin_admin ) {
        ...
        //Same but for admin pages
        $this->loader->add_action( 'admin_footer', $plugin_admin, 'chat_div_window', 1 );
        $this->loader->add_action( 'admin_footer', $plugin_admin, 'chat_window', 2 );
    }
