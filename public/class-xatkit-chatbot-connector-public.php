 ...
 * @subpackage Xatkit_Chatbot_Connector\public
 */

class Xatkit_Chatbot_Connector_Public {
    ...
    //    wp_enqueue_style( 'xatkit_css', 'https://dev.xatkit.com/static/xatkit.min.css', array(), null, 'all' );
        wp_enqueue_style( $this->plugin_name . '_public_aux', plugin_dir_url( __FILE__ ) . 'css/xatkit-chatbot-connector-public.css', array(), $this->version, 'all' );
    ...
    public function chat_window() {
        ...
        if ( $configurations['enabled'] && $configurations['serverUrl'] !== '' && !$configurations['inAdmin']) {  // Check if bot is configured
